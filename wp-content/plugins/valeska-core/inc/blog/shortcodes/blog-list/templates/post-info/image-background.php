...
if ( $has_image ) {
	...
	$image_url       = valeska_core_get_list_shortcode_item_image_url( $image_dimension, $blog_list_image );
	...
	<div class="qodef-e-media-image qodef--background" <?php qode_framework_inline_style( $style ); ?>>
		<?php echo valeska_core_get_list_shortcode_item_image( $image_dimension, $blog_list_image ); ?>
	</div>
<?php } ?>
