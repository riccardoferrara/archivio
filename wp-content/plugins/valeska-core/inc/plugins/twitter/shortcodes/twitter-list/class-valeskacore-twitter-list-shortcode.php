...
if ( ! function_exists( 'valeska_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_twitter_list_shortcode( $shortcodes ) {
		if ( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'ValeskaCore_Twitter_List_Shortcode';
		}

		return $shortcodes;
	}

	add_filter( 'valeska_core_filter_register_shortcodes', 'valeska_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'ValeskaCore_List_Shortcode' ) ) {
	class ValeskaCore_Twitter_List_Shortcode extends ValeskaCore_List_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( VALESKA_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'valeska_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'valeska-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'valeska-core' ) );
			...
			$this->set_option(
				array(
					...
					'field_type' => 'text',
					'title'      => esc_html__( 'Number of Tweets', 'valeska-core' ),
					'group'      => esc_html__( 'Info', 'valeska-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Retweeted Text', 'valeska-core' ),
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Avatar Image', 'valeska-core' ),
					'options'       => valeska_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'valeska-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Author Name', 'valeska-core' ),
					'options'       => valeska_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'valeska-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Text', 'valeska-core' ),
					'options'       => valeska_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'valeska-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Media Placeholder', 'valeska-core' ),
			...
			$this->set_option(
				array(
					'name'          => 'show_date',
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Date', 'valeska-core' ),
					'options'       => valeska_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'valeska-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Actions', 'valeska-core' ),
					'options'       => valeska_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'valeska-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Twitter Link', 'valeska-core' ),
					'options'       => valeska_core_get_select_type_options_pool( 'no_yes' ),
					'default_value' => 'no',
					'group'         => esc_html__( 'Info', 'valeska-core' ),
				)
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'valeska_core_twitter_list', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return valeska_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
