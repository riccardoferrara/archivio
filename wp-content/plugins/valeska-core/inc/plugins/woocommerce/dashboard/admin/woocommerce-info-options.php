...
if ( ! function_exists( 'valeska_core_add_product_info_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function valeska_core_add_product_info_typography_options( $page ) {
		...
		if ( $page ) {
			$product_info_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Product Info', 'valeska-core' ),
					'description' => esc_html__( 'Set typography values for product info elements', 'valeska-core' ),
				)
			);
			...
			$price_typography_section = $product_info_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Price Typography', 'valeska-core' ),
				)
			);
			...
			$product_price_typography_row = $price_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Price Styles', 'valeska-core' ),
				)
			);
			...
			$product_price_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Discount Color', 'valeska-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$product_single_price_typography_row = $price_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Single Price Styles', 'valeska-core' ),
				)
			);
			...
			$product_info_typography_section = $product_info_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Product Info Typography', 'valeska-core' ),
				)
			);
			...
			$product_label_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Label Styles', 'valeska-core' ),
				)
			);
			...
			$product_info_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Styles', 'valeska-core' ),
				)
			);
			...
			$product_info_link_typography_row = $product_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Product Info Link Styles', 'valeska-core' ),
				)
			);
	...
	add_action( 'valeska_core_action_after_woo_options_map', 'valeska_core_add_product_info_typography_options' );
}
