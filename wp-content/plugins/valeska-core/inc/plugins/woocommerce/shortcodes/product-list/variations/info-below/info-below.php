...
if ( ! function_exists( 'valeska_core_add_product_list_variation_info_below' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_product_list_variation_info_below( $variations ) {
		$variations['info-below'] = esc_html__( 'Info Below', 'valeska-core' );

		return $variations;
	}

	add_filter( 'valeska_core_filter_product_list_layouts', 'valeska_core_add_product_list_variation_info_below' );
}

if ( ! function_exists( 'valeska_core_register_shop_list_info_below_actions' ) ) {
	/**
	 * Function that override product item layout for current variation type
	 */
	function valeska_core_register_shop_list_info_below_actions() {
	...
	add_action( 'valeska_core_action_shop_list_item_layout_info-below', 'valeska_core_register_shop_list_info_below_actions' );
}
