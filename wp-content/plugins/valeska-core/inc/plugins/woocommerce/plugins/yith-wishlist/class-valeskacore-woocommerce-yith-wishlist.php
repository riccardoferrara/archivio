...
if ( ! class_exists( 'ValeskaCore_WooCommerce_YITH_Wishlist' ) ) {
	class ValeskaCore_WooCommerce_YITH_Wishlist {
		...
		/**
		 * @return ValeskaCore_WooCommerce_YITH_Wishlist
		 */
		...
		function change_templates_position() {
			...
			add_action( 'valeska_action_product_list_item_additional_image_content', 'valeska_core_get_yith_wishlist_shortcode' );
			add_action( 'valeska_core_action_product_list_item_additional_image_content', 'valeska_core_get_yith_wishlist_shortcode' );
		}
	...
	ValeskaCore_WooCommerce_YITH_Wishlist::get_instance();
}
