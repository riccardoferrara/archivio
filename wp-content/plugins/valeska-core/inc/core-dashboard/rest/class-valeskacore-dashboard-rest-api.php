...
if ( ! class_exists( 'ValeskaCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class ValeskaCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'valeska_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return ValeskaCore_Dashboard_Rest_API
		 */
	...
	ValeskaCore_Dashboard_Rest_API::get_instance();
}
