<div class="qodef-core-dashboard wrap about-wrap">
	<h1 class="qodef-cd-title"><?php esc_html_e( 'System Status', 'valeska-core' ); ?></h1>
	<h4 class="qodef-cd-subtitle"><?php esc_html_e( 'Here is a general overview of your system status', 'valeska-core' ); ?></h4>
	<div class="qodef-core-dashboard-inner">
		<div class="qodef-core-dashboard-column">
			<div class="qodef-core-dashboard-box">
				<div class="qodef-cd-box-title-holder">
					<h2><?php esc_html_e( 'WordPress Environment', 'valeska-core' ); ?></h2>
				</div>
		...
		<div class="qodef-core-dashboard-column">
			<div class="qodef-core-dashboard-box">
				<div class="qodef-cd-box-title-holder">
					<h2><?php esc_html_e( 'Theme Information', 'valeska-core' ); ?></h2>
				</div>
				<div class="qodef-cd-box-inner">
			...
			<div class="qodef-core-dashboard-box">
				<div class="qodef-cd-box-title-holder">
					<h2><?php esc_html_e( 'Active Plugins', 'valeska-core' ); ?><sup>(<?php echo count( $plugins ); ?>)</sup></h2>
				</div>
				<div class="qodef-cd-box-inner">
					<?php foreach ( $plugins as $plugin_key => $plugin_value ) : ?>
						<div class="qodef-cd-box-row">
							...
							<div class="qodef-cdb-value">
								<?php esc_html_e( 'by', 'valeska-core' ); ?> <a href="<?php echo esc_url( $plugin_value['author_url'] ); ?>" target="_blank"><?php echo wp_kses_post( $plugin_value['author'] ); ?></a>- <?php echo wp_kses_post( $plugin_value['version'] ); ?>
							</div>
						</div>
					<?php endforeach; ?>
				</div>
