...
if ( ! class_exists( 'ValeskaCore_Custom_Post_Types' ) ) {
	class ValeskaCore_Custom_Post_Types {
		...
		/**
		 * @return ValeskaCore_Custom_Post_Types
		 */
		...
		function init() {
			...
			include_once VALESKA_CORE_CPT_PATH . '/dashboard/customizer/post-types-customizer-options.php';
		}
		...
		function set_enabled_post_types() {
			...
			do_action( 'valeska_core_action_add_custom_post_type', $this );
		}
		...
		function register_post_types() {
			...
			$cpts           = apply_filters( 'valeska_core_filter_register_custom_post_types', $cpts = array() );
		...
		function include_taxonomies() {
			...
			do_action( 'valeska_core_action_include_cpt_tax_fields' );
		}

		function register_taxonomies() {
			// Hook to includes custom post types taxonomy fields
			do_action( 'valeska_core_action_register_cpt_tax_fields' );
		}
	...
	ValeskaCore_Custom_Post_Types::get_instance();
}
