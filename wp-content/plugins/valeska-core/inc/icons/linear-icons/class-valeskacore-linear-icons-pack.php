...
if ( ! function_exists( 'valeska_core_add_linear_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_linear_icons_to_collection( $icons ) {
		$icons[] = 'ValeskaCore_Linear_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'valeska_core_add_linear_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ValeskaCore_Linear_Icons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'valeska_core_filter_linear_specific_icons',
				array(
