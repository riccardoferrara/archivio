...
if ( ! function_exists( 'valeska_core_add_simple_line_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_simple_line_icons_to_collection( $icons ) {
		$icons[] = 'ValeskaCore_Simple_Line_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'valeska_core_add_simple_line_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ValeskaCore_Simple_Line_Icons_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return VALESKA_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/' . $this->get_base() . '.min.css';
		}
		...
		function specific_icons() {
			return apply_filters(
				'valeska_core_filter_simple_line_specific_icons',
				array(
