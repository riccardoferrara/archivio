...
if ( ! function_exists( 'valeska_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'ValeskaCore_Font_Awesome_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'valeska_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ValeskaCore_Font_Awesome_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return VALESKA_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function specific_icons() {
			return apply_filters(
				'valeska_core_filter_font_awesome_specific_icons',
				array(
					'search'        => 'fa fa-search',
		...
		function get_new_icons_list() {
			...
			if ( file_exists( VALESKA_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( VALESKA_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
