...
if ( ! function_exists( 'valeska_core_add_ionicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'ValeskaCore_IonIcons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'valeska_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ValeskaCore_IonIcons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'valeska_core_filter_ion_specific_icons',
				array(
