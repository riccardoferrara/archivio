...
if ( ! function_exists( 'valeska_core_set_elements_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function valeska_core_set_elements_styles( $style ) {
		$label_styles = valeska_core_get_typography_styles( 'qodef_elements_label' );
		...
		$input_styles         = valeska_core_get_typography_styles( 'qodef_elements_input_fields' );
		$fields_bg_color      = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_background_color' );
		$fields_border_color  = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_color' );
		$fields_border_width  = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_width' );
		$fields_border_radius = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_radius' );
		$fields_border_style  = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_style' );
		$fields_padding       = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_padding' );
		...
		$fields_focus_color        = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_focus_color' );
		$fields_bg_focus_color     = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_background_focus_color' );
		$fields_border_focus_color = valeska_core_get_post_value_through_levels( 'qodef_elements_input_fields_border_focus_color' );
		...
		$button_styles        = valeska_core_get_typography_styles( 'qodef_elements_buttons' );
		$button_bg_color      = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_background_color' );
		$button_border_color  = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_border_color' );
		$button_border_width  = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_border_width' );
		$button_border_radius = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_border_radius' );
		$button_border_style  = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_border_style' );
		$button_box_shadow    = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_box_shadow' );
		$button_padding       = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_padding' );
		...
		$button_hover_color        = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_hover_color' );
		$button_bg_hover_color     = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_background_hover_color' );
		$button_border_hover_color = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_border_hover_color' );
		...
		$button_simple_styles = valeska_core_get_typography_styles( 'qodef_elements_buttons_simple' );
		...
		$button_simple_hover_color           = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_simple_hover_color' );
		$button_simple_hover_text_decoration = valeska_core_get_post_value_through_levels( 'qodef_elements_buttons_simple_hover_text_decoration' );
		...
		$slider_arrow_color    = valeska_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_color' );
		$slider_arrow_bg_color = valeska_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_background_color' );
		...
		$slider_arrow_svg_size   = valeska_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_size' );
		...
		$slider_arrow_hover_color    = valeska_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_hover_color' );
		$slider_arrow_bg_hover_color = valeska_core_get_post_value_through_levels( 'qodef_elements_slider_arrow_background_hover_color' );
	...
	add_filter( 'valeska_filter_add_inline_style', 'valeska_core_set_elements_styles' );
}
