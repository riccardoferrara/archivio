...
if ( ! function_exists( 'valeska_core_fullscreen_menu_typography_options' ) ) {
	/**
	 * Function that add additional header menu layout global options
	 *
	 * @param object $page
	 */
	function valeska_core_fullscreen_menu_typography_options( $page ) {
		...
		if ( $page ) {
			...
			$typography_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Fullscreen Menu Typography', 'valeska-core' ),
				)
			);
	...
	add_action( 'valeska_core_action_after_fullscreen_menu_options_map', 'valeska_core_fullscreen_menu_typography_options', 15 );
}
