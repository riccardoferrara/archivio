...
if ( ! function_exists( 'valeska_core_add_page_logo_meta_box' ) ) {
	/**
	 * Function that add general meta box options for this module
	 *
	 * @param object $page
	 */
	function valeska_core_add_page_logo_meta_box( $page ) {
		...
		if ( $page ) {
			...
			$logo_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-logo',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Logo Settings', 'valeska-core' ),
					'description' => esc_html__( 'Logo settings', 'valeska-core' ),
				)
			);
			...
			do_action( 'valeska_core_action_after_header_logo_image_section_meta_map', $logo_tab, $header_logo_section, $logo_image_section );
			...
			do_action( 'valeska_core_action_before_header_logo_svg_path_section_meta_map', $logo_tab, $header_logo_section, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'valeska_core_action_after_header_logo_svg_path_section_meta_map', $logo_tab, $header_logo_section, $logo_svg_path_section );
			...
			// Hook to include additional options before section part
			do_action( 'valeska_core_action_before_header_logo_textual_section_meta_map', $logo_tab, $header_logo_section, $logo_textual_section );
			...
			// Hook to include additional options after section part
			do_action( 'valeska_core_action_after_header_logo_textual_section_meta_map', $logo_tab, $header_logo_section, $logo_textual_section );

			// Hook to include additional options after module options
			do_action( 'valeska_core_action_after_page_logo_meta_map', $logo_tab, $header_logo_section );
		}
	}

	add_action( 'valeska_core_action_after_general_meta_box_map', 'valeska_core_add_page_logo_meta_box' );
}

if ( ! function_exists( 'valeska_core_add_general_logo_meta_box_callback' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_general_logo_meta_box_callback( $callbacks ) {
		$callbacks['logo'] = 'valeska_core_add_page_logo_meta_box';

		return $callbacks;
	}

	add_filter( 'valeska_core_filter_general_meta_box_callbacks', 'valeska_core_add_general_logo_meta_box_callback' );
}
