...
class ValeskaCore_Standard_Header extends ValeskaCore_Header {
	...
	/**
	 * @return ValeskaCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return valeska_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
