...
if ( ! function_exists( 'valeska_core_add_standard_header_options' ) ) {
	/**
	 ...
	 */
	function valeska_core_add_standard_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'        => 'qodef_standard_header_section',
				'title'       => esc_html__( 'Standard Header', 'valeska-core' ),
				'description' => esc_html__( 'Standard header settings', 'valeska-core' ),
				'dependency'  => array(
					'show' => array(
	...
	add_action( 'valeska_core_action_after_header_options_map', 'valeska_core_add_standard_header_options', 10, 2 );
}
