...
if ( ! function_exists( 'valeska_core_add_minimal_header_options' ) ) {
	/**
	 ...
	 */
	function valeska_core_add_minimal_header_options( $page, $general_header_tab ) {
	...
	add_action( 'valeska_core_action_after_header_options_map', 'valeska_core_add_minimal_header_options', 10, 2 );
}
