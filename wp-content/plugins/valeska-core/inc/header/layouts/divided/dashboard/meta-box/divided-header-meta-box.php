...
if ( ! function_exists( 'valeska_core_add_divided_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function valeska_core_add_divided_header_meta( $page ) {
	...
	add_action( 'valeska_core_action_after_page_header_meta_map', 'valeska_core_add_divided_header_meta' );
}
