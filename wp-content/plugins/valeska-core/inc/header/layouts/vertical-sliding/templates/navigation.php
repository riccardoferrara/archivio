<?php if ( has_nav_menu( 'vertical-menu-navigation' ) || has_nav_menu( 'main-navigation' ) ) { ?>
	<nav class="qodef-header-vertical-sliding-navigation qodef-vertical-sliding-drop-down--below qodef-custom-header-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Vertical Sliding Menu', 'valeska-core' ); ?>">
		<?php
