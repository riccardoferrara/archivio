...
if ( ! function_exists( 'valeska_core_add_h5_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function valeska_core_add_h5_typography_options( $page ) {
		...
		if ( $page ) {
			$h5_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h5',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H5 Typography', 'valeska-core' ),
					'description' => esc_html__( 'Set values for Heading 5 HTML element', 'valeska-core' ),
				)
			);
	...
	add_action( 'valeska_core_action_after_typography_options_map', 'valeska_core_add_h5_typography_options' );
}
