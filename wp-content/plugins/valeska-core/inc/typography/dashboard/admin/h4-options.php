...
if ( ! function_exists( 'valeska_core_add_h4_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function valeska_core_add_h4_typography_options( $page ) {
		...
		if ( $page ) {
			$h4_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h4',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H4 Typography', 'valeska-core' ),
					'description' => esc_html__( 'Set values for Heading 4 HTML element', 'valeska-core' ),
				)
			);
			...
			/* 1440 styles */
			$h4_1440_typography_section = $h4_tab->add_section_element(
				array(
					'name'  => 'qodef_responsive_1440_typography_h4',
					'title' => esc_html__( 'Responsive 1440 Typography', 'valeska-core' ),
				)
			);

			$responsive_1440_typography_h4_row = $h4_1440_typography_section->add_row_element(
				array(
					'name' => 'qodef_responsive_1440_h4_typography_row',
				)
			);

			$responsive_1440_typography_h4_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h4_responsive_1440_font_size',
					'title'      => esc_html__( 'Font Size', 'valeska-core' ),
					'args'       => array(
						'col_width' => 4,
					),
			...
			$responsive_1440_typography_h4_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h4_responsive_1440_line_height',
					'title'      => esc_html__( 'Line Height', 'valeska-core' ),
					'args'       => array(
						'col_width' => 4,
					),
			...
			$responsive_1440_typography_h4_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h4_responsive_1440_letter_spacing',
					'title'      => esc_html__( 'Letter Spacing', 'valeska-core' ),
					'args'       => array(
						'col_width' => 4,
					),
	...
	add_action( 'valeska_core_action_after_typography_options_map', 'valeska_core_add_h4_typography_options' );
}
