...
if ( ! function_exists( 'valeska_core_add_h6_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function valeska_core_add_h6_typography_options( $page ) {
		...
		if ( $page ) {
			$h6_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h6',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H6 Typography', 'valeska-core' ),
					'description' => esc_html__( 'Set values for Heading 6 HTML element', 'valeska-core' ),
				)
			);
			...
			/* 1440 styles */
			$h6_1440_typography_section = $h6_tab->add_section_element(
				array(
					'name'  => 'qodef_responsive_1440_typography_h6',
					'title' => esc_html__( 'Responsive 1440 Typography', 'valeska-core' ),
				)
			);

			$responsive_1440_typography_h6_row = $h6_1440_typography_section->add_row_element(
				array(
					'name' => 'qodef_responsive_1440_h6_typography_row',
				)
			);

			$responsive_1440_typography_h6_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h6_responsive_1440_font_size',
					'title'      => esc_html__( 'Font Size', 'valeska-core' ),
					'args'       => array(
						'col_width' => 4,
					),
			...
			$responsive_1440_typography_h6_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h6_responsive_1440_line_height',
					'title'      => esc_html__( 'Line Height', 'valeska-core' ),
					'args'       => array(
						'col_width' => 4,
					),
			...
			$responsive_1440_typography_h6_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h6_responsive_1440_letter_spacing',
					'title'      => esc_html__( 'Letter Spacing', 'valeska-core' ),
					'args'       => array(
						'col_width' => 4,
					),
	...
	add_action( 'valeska_core_action_after_typography_options_map', 'valeska_core_add_h6_typography_options' );
}
