	...
	<div <?php qode_framework_class_attribute( $holder_classes ); ?>>
		...
		<?php foreach ( $items as $item ) { ?>
			<div class="qodef-m-table">
				...
				<?php if ( 'yes' === $item['show_button'] && class_exists( 'ValeskaCore_Button_Shortcode' ) ) { ?>
					<div class="qodef-m-footer">
						<?php echo ValeskaCore_Button_Shortcode::call_shortcode( $this_shortcode->get_button_params( $item ) ); ?>
					</div>
				<?php } ?>
			</div>
		<?php } ?>
