		...
		if ( ! empty( $images ) ) {
			foreach ( $images as $image ) {
				...
				if ( 'fixed' === $masonry_images_proportion ) {
					$image_size_meta = valeska_core_get_custom_image_size_meta( 'attachment', 'qodef_image_gallery_masonry_size', $image['image_id'] );
				...
				valeska_core_template_part( 'shortcodes/image-gallery', 'templates/parts/image', '', array_merge( $params, $image ) );
			}
		}
		?>
	</div>
