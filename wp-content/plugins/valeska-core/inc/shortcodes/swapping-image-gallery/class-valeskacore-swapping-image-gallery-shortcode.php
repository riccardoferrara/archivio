...
if ( ! function_exists( 'valeska_core_add_swapping_image_gallery_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_swapping_image_gallery_shortcode( $shortcodes ) {
		$shortcodes[] = 'ValeskaCore_Swapping_Image_Gallery_Shortcode';

		return $shortcodes;
	}

	add_filter( 'valeska_core_filter_register_shortcodes', 'valeska_core_add_swapping_image_gallery_shortcode' );
}

if ( class_exists( 'ValeskaCore_Shortcode' ) ) {
	class ValeskaCore_Swapping_Image_Gallery_Shortcode extends ValeskaCore_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( VALESKA_CORE_SHORTCODES_URL_PATH . '/swapping-image-gallery' );
			$this->set_base( 'valeska_core_swapping_image_gallery' );
			$this->set_name( esc_html__( 'Swapping Image Gallery', 'valeska-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds swapping image gallery holder', 'valeska-core' ) );
			...
			$this->set_option(
				array(
					...
					'title'      => esc_html__( 'Description', 'valeska-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'items'      => array(
						...
						array(
							...
							'title'      => esc_html__( 'Thumbnail Image', 'valeska-core' ),
						),
					),
				)
			);
		...
		public function render( $options, $content = null ) {
			...
			return valeska_core_get_template_part( 'shortcodes/swapping-image-gallery', 'templates/swapping-image-gallery', '', $atts );
		}
