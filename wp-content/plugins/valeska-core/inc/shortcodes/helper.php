...
if ( ! function_exists( 'valeska_core_get_list_shortcode_item_image' ) ) {
	/**
	 ...
	 */
	function valeska_core_get_list_shortcode_item_image( $image_dimension, $attachment_id = 0, $custom_image_width = 0, $custom_image_height = 0 ) {
		$item_id = get_the_ID();
		...
		return apply_filters( 'valeska_core_filter_list_shortcode_item_image', $html, $attachment_id );
	}
}

if ( ! function_exists( 'valeska_core_get_list_shortcode_item_image_url' ) ) {
	/**
	 ...
	 * @return string
	 */
	function valeska_core_get_list_shortcode_item_image_url( $image_dimension, $attachment_id = 0 ) {
