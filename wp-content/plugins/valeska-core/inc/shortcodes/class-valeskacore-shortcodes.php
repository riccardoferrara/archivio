...
if ( ! class_exists( 'ValeskaCore_Shortcodes' ) ) {
	class ValeskaCore_Shortcodes {
		...
		function init() {
			...
			include_once VALESKA_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once VALESKA_CORE_SHORTCODES_PATH . '/class-valeskacore-shortcode.php';
			include_once VALESKA_CORE_SHORTCODES_PATH . '/class-valeskacore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'valeska_core_filter_register_shortcodes', $shortcodes = array() );
	...
	ValeskaCore_Shortcodes::get_instance();
}
