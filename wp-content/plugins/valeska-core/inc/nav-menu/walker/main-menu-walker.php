...
if ( ! class_exists( 'ValeskaCoreRootMainMenuWalker' ) ) {
	class ValeskaCoreRootMainMenuWalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = null ) {
			...
			if ( 0 === $depth ) {
				...
				$inner_classes = apply_filters( 'valeska_core_filter_drop_down_second_inner_classes', array( 'qodef-drop-down-second-inner' ) );
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			$anchor_link      = valeska_core_get_option_value( 'nav-menu', 'qodef-enable-anchor-link', '', $item->ID );
			$menu_appearance  = valeska_core_get_option_value( 'nav-menu', 'qodef-menu-item-appearance', '', $item->ID );
			$mega_menu_widget = valeska_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu-widget', '', $item->ID );
			$menu_icon_pack   = valeska_core_get_option_value( 'nav-menu', 'qodef-menu-item-icon-pack', '', $item->ID );
			$menu_icon        = valeska_core_get_option_value( 'nav-menu', 'qodef-menu-item-icon-pack-icon', '', $item->ID );
