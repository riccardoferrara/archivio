...
if ( ! function_exists( 'valeska_core_dropdown_item_classes' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_dropdown_item_classes( $classes, $item, $args, $depth ) {

		if ( 0 === $depth && in_array( 'menu-item-has-children', $item->classes, true ) ) {
			$mega_menu   = valeska_core_get_option_value( 'nav-menu', 'qodef-enable-mega-menu', '', $item->ID );
			...
			if ( $mega_menu_e ) {
				...
				add_filter(
					'valeska_core_filter_drop_down_second_inner_classes',
					function ( $inner_classes ) {
						$grid_class = false;
						$full_width = valeska_core_get_post_value_through_levels( 'qodef_wide_dropdown_full_width' );
						$grid       = valeska_core_get_post_value_through_levels( 'qodef_wide_dropdown_content_grid' );

						if ( 'yes' === $grid || 'no' === $full_width ) {
							$grid_class = true;
						}

						$grid_class = apply_filters( 'valeska_core_filter_drop_down_grid', $grid_class );
	...
	add_filter( 'nav_menu_css_class', 'valeska_core_dropdown_item_classes', 11, 4 );
}

if ( ! function_exists( 'valeska_core_add_nav_menu_body_classes' ) ) {
	/**
	 ...
	 * @return array
	 */
	function valeska_core_add_nav_menu_body_classes( $classes ) {
		$full_width = valeska_core_get_post_value_through_levels( 'qodef_wide_dropdown_full_width' );
		$appearance = valeska_core_get_post_value_through_levels( 'qodef_dropdown_appearance' );
	...
	add_filter( 'body_class', 'valeska_core_add_nav_menu_body_classes' );
}

if ( ! function_exists( 'valeska_core_set_nav_menu_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function valeska_core_set_nav_menu_styles( $style ) {
		$styles = array();

		$dropdown_top_position = valeska_core_get_post_value_through_levels( 'qodef_dropdown_top_position' );
		...
		$dropdown_bg_color = valeska_core_get_post_value_through_levels( 'qodef_dropdown_background_color' );
		...
		$wide_dropdown_bg_color = valeska_core_get_post_value_through_levels( 'qodef_wide_dropdown_background_color' );
	...
	add_filter( 'valeska_filter_add_inline_style', 'valeska_core_set_nav_menu_styles' );
}

if ( ! function_exists( 'valeska_core_set_nav_menu_typography_styles' ) ) {
	/**
	 * Function that generates module inline styles
	 *
	 * @param string $style
	 ...
	 * @return string
	 */
	function valeska_core_set_nav_menu_typography_styles( $style ) {
		$first_lvl_styles             = valeska_core_get_typography_styles( 'qodef_nav_1st_lvl' );
		$first_lvl_hover_styles       = valeska_core_get_typography_hover_styles( 'qodef_nav_1st_lvl' );
		$second_lvl_styles            = valeska_core_get_typography_styles( 'qodef_nav_2nd_lvl' );
		$second_lvl_hover_styles      = valeska_core_get_typography_hover_styles( 'qodef_nav_2nd_lvl' );
		$second_lvl_wide_styles       = valeska_core_get_typography_styles( 'qodef_nav_2nd_lvl_wide' );
		$second_lvl_wide_hover_styles = valeska_core_get_typography_hover_styles( 'qodef_nav_2nd_lvl_wide' );
		$third_lvl_wide_styles        = valeska_core_get_typography_styles( 'qodef_nav_3rd_lvl_wide' );
		$third_lvl_wide_hover_styles  = valeska_core_get_typography_hover_styles( 'qodef_nav_3rd_lvl_wide' );

		$header_selector      = apply_filters( 'valeska_core_filter_nav_menu_header_selector', '.qodef-header-navigation' );
		$narrow_menu_selector = apply_filters( 'valeska_core_filter_nav_menu_narrow_header_selector', '.qodef-menu-item--narrow' );
		$wide_menu_selector   = '.qodef-menu-item--wide';

		$first_lvl_side_padding = valeska_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_padding' );
		...
		$first_lvl_active_color = valeska_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_active_color' );
		...
		$first_lvl_side_margin = valeska_core_get_option_value( 'admin', 'qodef_nav_1st_lvl_margin' );
		...
		$second_lvl_active_color = valeska_core_get_option_value( 'admin', 'qodef_nav_2nd_lvl_active_color' );
		...
		$second_lvl_wide_active_color = valeska_core_get_option_value( 'admin', 'qodef_nav_2nd_lvl_wide_active_color' );
		...
		$third_lvl_wide_active_color = valeska_core_get_option_value( 'admin', 'qodef_nav_3rd_lvl_wide_active_color' );
	...
	add_filter( 'valeska_filter_add_inline_style', 'valeska_core_set_nav_menu_typography_styles' );
}
