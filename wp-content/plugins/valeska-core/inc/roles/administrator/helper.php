...
if ( ! function_exists( 'valeska_core_add_administrator_role_caps' ) ) {
	/**
	 * Function that add user role capabilities for custom post types
	 */
	function valeska_core_add_administrator_role_caps() {

		// Add the roles you'd like to administer the custom post types
		$roles = apply_filters( 'valeska_core_filter_administrator_roles', array( 'editor', 'administrator' ) );

		// Allowed custom post types
		$cpt_items = apply_filters( 'valeska_core_filter_administrator_cpts', array() );
	...
	add_action( 'valeska_core_action_plugin_loaded', 'valeska_core_add_administrator_role_caps' );
}
