...
if ( ! function_exists( 'valeska_core_search_options' ) ) {
	/**
	 * Function that add global module options
	 */
	function valeska_core_search_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'search',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Search', 'valeska-core' ),
				'description' => esc_html__( 'Global Search Options', 'valeska-core' ),
			)
		);
		...
		if ( $page ) {
			$search_page_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Search Page', 'valeska-core' ),
				)
			);
			...
			$search_page_section->add_field_element(
				array(
					...
					'description' => esc_html__( 'Use this option to enable/disable page title on search page', 'valeska-core' ),
			...
			$search_page_section->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose default sidebar layout for search page', 'valeska-core' ),
			...
			if ( ! empty( $custom_sidebars ) && count( $custom_sidebars ) > 1 ) {
				$search_page_section->add_field_element(
					array(
						...
						'description' => esc_html__( 'Choose a custom sidebar to display on search page', 'valeska-core' ),
			...
			$search_page_section->add_field_element(
				array(
					...
					'description' => esc_html__( 'Choose grid gutter size to set space between content and sidebar for search page', 'valeska-core' ),
			...
			do_action( 'valeska_core_action_after_search_page_options_map', $search_page_section );

			$search_opener_section = $page->add_section_element(
				array(
					'name'  => 'qodef_search_opener_section',
					'title' => esc_html__( 'Search Opener', 'valeska-core' ),
				)
			);
			...
			$search_opener_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Search Icon Source', 'valeska-core' ),
					'default_value' => 'icon_pack',
					'options'       => valeska_core_get_select_type_options_pool( 'icon_source', false, array( 'predefined' ) ),
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Search Open Icon SVG Path', 'valeska-core' ),
					'description' => esc_html__( 'Enter your search open icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'valeska-core' ),
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Search Close Icon SVG Path', 'valeska-core' ),
					'description' => esc_html__( 'Enter your search close icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'valeska-core' ),
				)
			);
			...
			$search_opener_section->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Search Icon Size', 'valeska-core' ),
					'args'       => array(
			...
			$color_row = $search_opener_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Search Icon', 'valeska-core' ),
				)
			);
			...
			$color_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Search Icon Color', 'valeska-core' ),
				)
			);
			...
			$color_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Search Icon Hover Color', 'valeska-core' ),
				)
			);
			...
			$search_opener_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Search Icon Label', 'valeska-core' ),
					'default_value' => 'no',
			...
			// Hook to include additional options after module options
			do_action( 'valeska_core_action_after_search_options_map', $page );
		}
	}

	add_action( 'valeska_core_action_default_options_init', 'valeska_core_search_options', valeska_core_get_admin_options_map_position( 'search' ) );
}
