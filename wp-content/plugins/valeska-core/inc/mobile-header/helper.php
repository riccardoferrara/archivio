...
if ( ! function_exists( 'valeska_core_dependency_for_mobile_menu_typography_options' ) ) {
	/**
	 * Function that set dependency values for module global options
	 *
	 * @return array
	 */
	function valeska_core_dependency_for_mobile_menu_typography_options() {
		return apply_filters( 'valeska_core_filter_mobile_menu_typography_hide_option', array() );
	}
}

if ( ! function_exists( 'valeska_core_set_mobile_header_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function valeska_core_set_mobile_header_styles( $style ) {
		$opener_styles    = array();
		$opener_color     = valeska_core_get_post_value_through_levels( 'qodef_mobile_header_opener_color' );
		$opener_icon_size = valeska_core_get_post_value_through_levels( 'qodef_mobile_header_opener_size' );
		...
		$opener_hover_color  = valeska_core_get_post_value_through_levels( 'qodef_mobile_header_opener_hover_color' );
	...
	add_filter( 'valeska_filter_add_inline_style', 'valeska_core_set_mobile_header_styles' );
}
