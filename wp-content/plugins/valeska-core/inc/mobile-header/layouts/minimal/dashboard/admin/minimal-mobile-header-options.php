...
if ( ! function_exists( 'valeska_core_add_minimal_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function valeska_core_add_minimal_mobile_header_options( $page, $general_tab ) {

		$section = $general_tab->add_section_element(
			array(
				'name'       => 'qodef_minimal_mobile_header_section',
				'title'      => esc_html__( 'Minimal Mobile Header', 'valeska-core' ),
				'dependency' => array(
					'show' => array(
		...
		$section->add_field_element(
			array(
				...
				'title'       => esc_html__( 'Minimal Height', 'valeska-core' ),
	...
	add_action( 'valeska_core_action_after_mobile_header_options_map', 'valeska_core_add_minimal_mobile_header_options', 10, 2 );
}
