...
if ( ! function_exists( 'valeska_core_add_side_area_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function valeska_core_add_side_area_mobile_header_options( $page, $general_tab ) {

		$section = $general_tab->add_section_element(
			array(
				'name'       => 'qodef_side_area_mobile_header_section',
				'title'      => esc_html__( 'Side Area Mobile Header', 'valeska-core' ),
				'dependency' => array(
					'show' => array(
	...
	add_action( 'valeska_core_action_after_mobile_header_options_map', 'valeska_core_add_side_area_mobile_header_options', 10, 2 );
}
