...
if ( ! function_exists( 'valeska_core_mobile_header_menu_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function valeska_core_mobile_header_menu_options( $page ) {
		...
		if ( $page ) {
			$mobile_menu_tab = $page->add_tab_element(
				array(
					...
					'icon'  => 'fa fa-cog',
					'title' => esc_html__( 'Mobile Menu Settings', 'valeska-core' ),
				)
			);
			...
			$typography_section = $mobile_menu_tab->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Mobile Menu Typography', 'valeska-core' ),
					'dependency' => array(
						'hide' => array(
							'qodef_mobile_header_layout' => array(
								'values'        => valeska_core_dependency_for_mobile_menu_typography_options(),
			...
			$first_level_typography_row = $typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu First Level Typography', 'valeska-core' ),
				)
			);
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Active Color', 'valeska-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Hover/Active Text Decoration', 'valeska-core' ),
					'options'    => valeska_core_get_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 3,
					),
			...
			$second_level_typography_row = $typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Second Level Typography', 'valeska-core' ),
				)
			);
	...
	add_action( 'valeska_core_action_after_mobile_header_options_map', 'valeska_core_mobile_header_menu_options' );
}
