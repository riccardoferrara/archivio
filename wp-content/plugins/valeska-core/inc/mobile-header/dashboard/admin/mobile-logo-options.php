...
if ( ! function_exists( 'valeska_core_add_mobile_logo_options' ) ) {
	/**
	 ...
	 */
	function valeska_core_add_mobile_logo_options( $page, $mobile_header_tab ) {
		...
		if ( $page ) {
			...
			$mobile_header_tab = $page->add_tab_element(
				array(
					...
					'description' => esc_html__( 'Set options for mobile headers', 'valeska-core' ),
				)
			);
			...
			do_action( 'valeska_core_action_after_mobile_logo_image_section_options_map', $page, $mobile_header_tab, $logo_image_section );
			...
			// Hook to include additional options after section part
			do_action( 'valeska_core_action_after_mobile_logo_svg_path_section_options_map', $page, $mobile_header_tab, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'valeska_core_action_after_mobile_logo_textual_section_options_map', $page, $mobile_header_tab, $logo_textual_section );

			do_action( 'valeska_core_action_after_mobile_logo_options_map', $page );
		}
	}

	add_action( 'valeska_core_action_after_header_logo_options_map', 'valeska_core_add_mobile_logo_options', 10, 2 );
}
